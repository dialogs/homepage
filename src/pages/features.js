                  ...
                  <dd data-slide="calls" className="feature_block__slide">
                    <div className="feature_block__slide__text">
                      ...
                      <p>
                        ...
                        снижает количество передаваемого аудио или видеотрафика
                        без разрыва или задержки соединения.
                      </p>
                  ...
                  <dd data-slide="files" className="feature_block__slide">
                    <div className="feature_block__slide__text">
                      ...
                      <p>
                        ...
                        названию файла и имени отправителя поможет быстро найти
                        важные данные.
                      </p>
                    </div>
                    <img
                  ...
                  >
                    <div className="feature_block__slide__text">
                      ...
                      <p>
                        ...
                        операционные системы Android, iOS, macOS, Windows и
                        Linux. Стабильная работа и синхронизация чатов в веб,
                        мобильном и десктопном клиентах.
                      </p>
                    </div>
                    <img
