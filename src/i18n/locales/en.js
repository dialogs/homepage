...
and reload the page.
  ...
  integrations_title: 'Integration makes Dialog even better',
  possibilities_header: 'Expand the capabilities of the messenger',
  possibilities_subtitle:
    'Connect Dialog to dozens of third-party applications and systems through:',
  botsdk: 'BotSDK',
  botsdk_description:
    'Create chat bots by yourself. Currently, the SDK is available for JS, Java, and Python.',
  ...
  webhooks_description:
    'The functions of the Dialog in WebHooks as an easy way to receive automatic messages and update data sent to a text channel on your server.',
  zapier: 'Zapier',
  zapier_description:
    'Use data and events in more than 1000 integrations to automate your workflow.',
  zapier_category1: 'Configure the integration right now.',
  graphql: 'GraphQL',
  graphql_description: 'Work with application data through GraphQL.',
  api: 'API',
  api_description:
    'Thanks to our API, you can create your own integrations and customize the dialog for your team and business. ',
  api_category1: 'Documentation',
  integrations_header: 'Integration Catalog',
  integrations_subtitle: 'Our most popular integrations',
  bots: 'Bots',
  design: 'Design',
  communication: 'Communications',
  asana_title: 'Asana Bot',
  asana_description: 'Bot quickly create reminders',
  asana_link: 'Source code',
  asana_language: 'Python',
  asana_category: 'Bot',
  google_title: 'Google Forms',
  google_description: 'Google Forms bot ',
  google_link: 'Source code',
  google_language: 'Java',
  google_category: 'Bot',
  reminder_title: 'Bot reminder',
  reminder_description: 'Bot quickly create reminders ',
  reminder_link: 'Source code',
  reminder_language: 'Python',
  reminder_category: 'Project management',
  integrations_card_language: 'Language',
  integrations_card_category: 'Category',
  invite_text:
    'To get to the integration directory, tell us about your work at @botsfordialog. We ask that the integrations listed here be well tested and include a README file with clear installation instructions.',
  open_header: 'Dialog Open Source Community',
  open_dev_title: 'For developers',
  open_dev_portfolio:
    'Open external project in a portfolio that future employers will enjoy.',
  open_dev_experience: 'Ability to improve your programming skills.',
  open_dev_subtitle: 'Bounty programs you can find here: ',
  open_bounce: 'Bountysource',
  open_bountify: 'Bountify',
  open_clients_title: 'For clients',
  open_clients_community: 'A community where you can find answers.',
  open_clients_libraries: 'Libraries of ready-made solutions for integrations.',
